...
if( !isset($_SESSION['user']) or substr($_SESSION['user'],0, 6) != "staff_" ){
  // echo "Executeddd";
	...
	<div class="header">
		<div class="container">
			...
			<div class="header-right">
                ...
                <button class="btn btn-primary" onclick="window.location.href='faculty_transcript.php'">Student transcript and aggregate view</button>
                <button class="btn btn-primary" onclick="window.location.href='probation_students.php'">List of probation students</button>

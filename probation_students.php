...
<body>
  ...
  $conn = mysqli_connect($servername, $username, $password, $dbname);
   ...
   $sql = "SELECT * FROM students where is_probated=1;";
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="header-right">
                      ...
                      <button class="btn btn-primary" onclick="window.location.href='generate_transcript.php'">Student transcript and aggregate view</button>

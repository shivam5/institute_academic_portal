...
<body>
  ...
  <form action="faculty_adding.php" method="post">

  <h1 id="lost">New User Registration
  ...
  <label>
     ...
     <span>Date of Joining (YYYY-MM-DD): &nbsp; </span>

     <br>

     <input type ="text" id="from-datepicker" name="doj" required><br>

  </label>

  <!-- <label>

     <span>Date of Leaving (YYYY-MM-DD) : &nbsp; </span>

     <br>

     <input type ="text" id="from-datepicker2" name="dol" required><br>
  ...
  <label>
     ...
     <span>Department Name (Must already be added in the department table):</span>

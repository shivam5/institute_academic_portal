...
if( !isset($_SESSION['user']) or (substr($_SESSION['user'],0, 8) != "faculty_"  and substr($_SESSION['user'],0, 6) != "staff_" ) ){
  // echo "Executeddd";
...
<body>
    ...
    <h1 id="lost">Viewing transcript

          <span id="lost_span">Enter entry number for the student.</span>

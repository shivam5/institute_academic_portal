...
<body>
    ...
    <form action="registering_student.php" method="post">

    <h1 id="lost">Course registration

          <span id="lost_span">Enter course id for which you want to register.</span>
    ...
    <label>
       ...
       <input type="text" name="c_id" required><br>

...
if( !isset($_SESSION['user']) or substr($_SESSION['user'],0, 4) != "hod_" ){
  // echo "Executeddd";
...
$hod_id = substr($username, 4, 17);
 ...
 $sql = "SELECT * FROM ticket where '" . $hod_id . "'=hod_id and current_holder = 3 and status = 0;";
 echo $sql;
...
<form action="accept_hod.php" method="post">

...
if( !isset($_SESSION['user']) or substr($_SESSION['user'],0, 5) != "dean_" ){
  // echo "Executeddd";
...
<body>
<?php
$dean_id = substr($username, 10, 17);

 $sql = "SELECT * FROM ticket where '" . $dean_id . "'=dean_id and current_holder = 4 and status = 0;";
 echo $sql;
    ...
    <div class="header">
        <div class="container">
            ...
            <div class="header-right">
                <button class="btn btn-primary" onclick="window.location.href='pending_tickets_hod.php'">Pending Tickets as HOD</button>
...
<form action="remove_ticket.php" method="post">

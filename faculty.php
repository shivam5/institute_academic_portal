	...
	<div class="header">
		<div class="container">
			...
			<div class="header-right">
                ...
                <button class="btn btn-primary" onclick="window.location.href='pending_instructor.php'">Tickets for instructor</button>
				<button class="btn btn-primary" onclick="window.location.href='pending_advisor.php'">Tickets for advisor</button>
